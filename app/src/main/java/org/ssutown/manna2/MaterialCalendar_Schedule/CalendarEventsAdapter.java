package org.ssutown.manna2.MaterialCalendar_Schedule;
...
import org.ssutown.manna2.MaterialCalendar_Schedule.CalendarEventItem;
...
public class CalendarEventsAdapter extends BaseAdapter {
    static ArrayList<org.ssutown.manna2.MaterialCalendar_Schedule.CalendarEventItem> listViewItemList = new ArrayList<org.ssutown.manna2.MaterialCalendar_Schedule.CalendarEventItem>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.person_material_saved_event_item, parent, false);
        }
        ...
        final org.ssutown.manna2.MaterialCalendar_Schedule.CalendarEventItem listViewItem = listViewItemList.get(position);
...
*/
    ...
    public void addItem(String title, String about) {
        org.ssutown.manna2.MaterialCalendar_Schedule.CalendarEventItem item = new CalendarEventItem(title, about);
